/**
 * ContactWS_ContactUpdateChild_Output.java
 *
...
public class ContactWS_ContactUpdateChild_Output  implements java.io.Serializable {
    private crmondemand.xml.contact.Contact[] listOfContact;

    public ContactWS_ContactUpdateChild_Output() {
    }
    ...
    /**
     * Gets the listOfContact value for this ContactWS_ContactUpdateChild_Output.
     * 
    ...
    /**
     * Sets the listOfContact value for this ContactWS_ContactUpdateChild_Output.
     * 
     * @param listOfContact
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactWS_ContactUpdateChild_Output)) return false;
        ContactWS_ContactUpdateChild_Output other = (ContactWS_ContactUpdateChild_Output) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactWS_ContactUpdateChild_Output.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:crmondemand/ws/contact/10/2004", ">ContactWS_ContactUpdateChild_Output"));
