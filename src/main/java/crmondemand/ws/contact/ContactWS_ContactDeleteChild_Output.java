/**
 * ContactWS_ContactDeleteChild_Output.java
 *
...
public class ContactWS_ContactDeleteChild_Output  implements java.io.Serializable {
    private crmondemand.xml.contact.Contact[] listOfContact;

    public ContactWS_ContactDeleteChild_Output() {
    }
    ...
    /**
     * Gets the listOfContact value for this ContactWS_ContactDeleteChild_Output.
     * 
    ...
    /**
     * Sets the listOfContact value for this ContactWS_ContactDeleteChild_Output.
     * 
     * @param listOfContact
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactWS_ContactDeleteChild_Output)) return false;
        ContactWS_ContactDeleteChild_Output other = (ContactWS_ContactDeleteChild_Output) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactWS_ContactDeleteChild_Output.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:crmondemand/ws/contact/10/2004", ">ContactWS_ContactDeleteChild_Output"));
