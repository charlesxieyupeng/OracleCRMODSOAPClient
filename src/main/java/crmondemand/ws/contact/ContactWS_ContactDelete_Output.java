/**
 * ContactWS_ContactDelete_Output.java
 *
...
public class ContactWS_ContactDelete_Output  implements java.io.Serializable {
    private crmondemand.xml.contact.Contact[] listOfContact;

    public ContactWS_ContactDelete_Output() {
    }
    ...
    /**
     * Gets the listOfContact value for this ContactWS_ContactDelete_Output.
     * 
    ...
    /**
     * Sets the listOfContact value for this ContactWS_ContactDelete_Output.
     * 
     * @param listOfContact
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactWS_ContactDelete_Output)) return false;
        ContactWS_ContactDelete_Output other = (ContactWS_ContactDelete_Output) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactWS_ContactDelete_Output.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:crmondemand/ws/contact/10/2004", ">ContactWS_ContactDelete_Output"));
