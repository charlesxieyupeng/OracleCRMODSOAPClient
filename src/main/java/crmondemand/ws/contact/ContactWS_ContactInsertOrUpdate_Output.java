...
public class ContactWS_ContactInsertOrUpdate_Output  implements java.io.Serializable {
    private crmondemand.xml.contact.Contact[] listOfContact;

    public ContactWS_ContactInsertOrUpdate_Output() {
    }
    ...
    /**
     * Gets the listOfContact value for this ContactWS_ContactInsertOrUpdate_Output.
     * 
    ...
    /**
     * Sets the listOfContact value for this ContactWS_ContactInsertOrUpdate_Output.
     * 
     * @param listOfContact
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactWS_ContactInsertOrUpdate_Output)) return false;
        ContactWS_ContactInsertOrUpdate_Output other = (ContactWS_ContactInsertOrUpdate_Output) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactWS_ContactInsertOrUpdate_Output.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:crmondemand/ws/contact/10/2004", ">ContactWS_ContactInsertOrUpdate_Output"));
