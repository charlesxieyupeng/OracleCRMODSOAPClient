...
public class ContactWS_ContactInsertChild_Output  implements java.io.Serializable {
    private crmondemand.xml.contact.Contact[] listOfContact;

    public ContactWS_ContactInsertChild_Output() {
    }
    ...
    /**
     * Gets the listOfContact value for this ContactWS_ContactInsertChild_Output.
     * 
    ...
    /**
     * Sets the listOfContact value for this ContactWS_ContactInsertChild_Output.
     * 
     * @param listOfContact
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactWS_ContactInsertChild_Output)) return false;
        ContactWS_ContactInsertChild_Output other = (ContactWS_ContactInsertChild_Output) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactWS_ContactInsertChild_Output.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:crmondemand/ws/contact/10/2004", ">ContactWS_ContactInsertChild_Output"));
