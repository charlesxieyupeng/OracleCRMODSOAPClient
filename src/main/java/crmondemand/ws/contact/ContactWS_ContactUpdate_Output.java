/**
 * ContactWS_ContactUpdate_Output.java
 *
...
public class ContactWS_ContactUpdate_Output  implements java.io.Serializable {
    private crmondemand.xml.contact.Contact[] listOfContact;

    public ContactWS_ContactUpdate_Output() {
    }
    ...
    /**
     * Gets the listOfContact value for this ContactWS_ContactUpdate_Output.
     * 
    ...
    /**
     * Sets the listOfContact value for this ContactWS_ContactUpdate_Output.
     * 
     * @param listOfContact
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactWS_ContactUpdate_Output)) return false;
        ContactWS_ContactUpdate_Output other = (ContactWS_ContactUpdate_Output) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactWS_ContactUpdate_Output.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:crmondemand/ws/contact/10/2004", ">ContactWS_ContactUpdate_Output"));
